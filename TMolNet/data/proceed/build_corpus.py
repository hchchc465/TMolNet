...
def main():
    ...
    parser.add_argument('--in_path', '-i', type=str, default='./data/esol.csv', help='input file')
    parser.add_argument('--out_path', '-o', type=str, default='./data/esol.txt', help='output file')
